...
template<uint64_t iblt_size_in_bytes, uint64_t sc_memory_in_bytes, uint32_t bucket_num = 200, int thre=200>
class SC_InsertableIBLT : public VirtualIBLT {
    StreamClassifier<sc_memory_in_bytes, bucket_num, 16, thre-15> sc;
