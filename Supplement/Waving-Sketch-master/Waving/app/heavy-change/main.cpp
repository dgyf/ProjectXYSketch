...
const string FILE_NAME="/home/yqliu/data/kosarak.dat";
//const string FILE_NAME="/home/yqliu/data/webdocs.dat";
//=============================================
...
void Test_Hitter(string PATH){
    for(int i = 0; i < 5; ++i){
        ...
        sketch[0] = new WavingSketch<8,1>(memory / 10, hit);
        sketch[1] = new WavingSketch<8,16>(memory / 10, hit);
