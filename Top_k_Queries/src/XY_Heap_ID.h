//
// Created by yqliu on 1/21/21.
//

#ifndef STREAMCLASSIFIER_XY_HEAP_ID_H
#define STREAMCLASSIFIER_XY_HEAP_ID_H
...
public:
    XY_Heap_ID(int capacity1, int cm_memory_in_bytes1, int num_bit) : heap_element_num(0) {
        capacity = capacity1;
...
#endif //STREAMCLASSIFIER_XY_HEAP_ID_H
